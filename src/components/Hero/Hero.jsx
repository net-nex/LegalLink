  ...
  return (
    <div className='hero justify-around' id='home'>
      <div className='w-full max-h-[100vh] min-h-[100vh] items-center flex flex-row justify-around  ' style={{background: 'linear-gradient(180deg, #132A47 0%, rgba(19, 42, 71, 0.00) 100%)'}}>
        <div className='flex item-center justify-around w-[50vw]'>
            <p className=' flex justify-center align-middle text-white text-5xl'>Welcome to your gateway to legal solutions where expertise meets convenience, and justice is just a click away</p>
        </div>
        <div className=''>
